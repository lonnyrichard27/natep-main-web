    ...
    <>
      <section className="border md:w-[500px] rounded-md p-5">
        <p className="flex gap-2 items-center">
          <FaRegArrowAltCircleLeft className='text-xl' /> <span>Verify Biometrics</span>
        </p>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-col">
            ...
            <p className='mt-3'>Position yourself at the center of the camera when taking a selfie.</p>
          </div>
        </div>
        ...
        <div className="flex gap-3 my-5">
          ...
          <div className="flex-col">
            ...
            <p className='mt-3'>Do not block your face with your hair, glasses or face mask when taking a selfie.</p>
          </div>
        </div>
        ...
        <div className="flex gap-3 my-5">
          ...
          <div className="flex-col">
            ...
            <p className='mt-3'>Ensure adequate light and a clear background when taking a selfie..</p>
          </div>
        </div>
